...
class EditCouponRequest extends FormRequest
{
    ...
    {
        return [
            // $this->segment(3) loại id để update, số 3 là vị trí id trên url và thêm dấu phẩy sau name
            'couponName'=>'required|min:2|max:50|unique:Coupons,name,' . $this->segment(3),
